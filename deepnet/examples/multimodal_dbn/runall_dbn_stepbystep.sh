...
deepnet=/media/DataDisk/myproject/deeplearning/deepnet/deepnet
...
prefix=/media/DataDisk/dataset/flickr-nips2012/flickr
...
# Make the output dir for modal and data
